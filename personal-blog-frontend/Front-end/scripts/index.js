...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    if (token) {
        // User đã đăng nhập - Load thông tin từ API
        try {
            ...
            if (response.ok) {
                ...
                if (userAvatar && (userAvatar.startsWith('data:image') || userAvatar.startsWith('http'))) {
                    ...
                    loginBtn.innerHTML = `<img src="../assets/imgs/account.png" alt="User" width="44" height="44" class="user-icon">`;
                }
            ...
            // Error loading user - clear and show login button
            localStorage.clear();
            loginBtn.textContent = 'Đăng nhập';
            loginBtn.onclick = function() {
                window.location.href = 'login.html';
...
function showUserMenu() {
    ...
    // Lấy avatar của user
    let userAvatar = '../assets/imgs/account.png';
    ...
    menu.innerHTML = `
        <div class="menu-user-info">
            <img src="${userAvatar}" alt="User" class="menu-icon" width="20" style="border-radius: 50%; object-fit: cover;">
            <span>${displayName}</span>
        </div>
        <a href="account.html" class="menu-item">
            <img src="../assets/imgs/user_info.png" alt="User" class="menu-icon" width="20">
            <span>Trang cá nhân</span>
        </a>
        <a href="saved-posts.html" class="menu-item">
            <img src="../assets/imgs/save.png" alt="Bookmark" class="menu-icon" width="20">
            <span>Bài viết theo dõi</span>
        </a>
        <a href="#" class="menu-item logout" onclick="logout(event)">
            <img src="../assets/imgs/logout.png" alt="Logout" class="menu-icon" width="20">
            <span>Đăng xuất</span>
        </a>
    `;
...
function readFullPost(postSlug) {
    // Chuyển hướng đến trang chi tiết bài viết với slug
    window.location.href = `post-detail.html?slug=${postSlug}`;
}
